    ...
    <Modal isOpen={isOpen} onClose={onClose} className='px-4 py-2 max-sm:w-auto rounded-sm'>
      {
        isRegisterPage ? (
          ...
          <div className="text-center mt-2 max-sm:mt-0">
            <div className="flex justify-center">
              <svg className="w-[300px] h-[20px] sm:w-[140px] sm:h-[20px] md:w-[183px] md:h-[25px]" viewBox="0 0 183 25" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <ModalTitle className='pt-2 flex justify-center text-center text-md text-zinc-400 max-sm:pt-0 mt-0 text-sm'>Faça Seu Cadastro</ModalTitle>
        </ModalHeader>
